...
ECHO.   
ECHO   changeset 327 = 327  No Data Yet!
ECHO.
...
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\327_No_Data.sql
ECHO Changeset 327 imported sucesfully!1
ECHO.
PAUSE   
GOTO changeset
