...
ECHO          บ      SkyFireDB 406a Rev 238    บ
...
ECHO   changeset 224 = 224
ECHO   changeset 225 = 225
ECHO   changeset 226 = 226
ECHO   changeset 227 = 227
ECHO   changeset 228 = 228
ECHO   changeset 229 = 229
ECHO   changeset 230 = 230
ECHO   changeset 231 = 231
ECHO   changeset 232 = 232
ECHO   changeset 233 = 233
ECHO   changeset 234 = 234
ECHO   changeset 235 = 235
ECHO   changeset 236 = 236
...
IF %ch%==224 GOTO changeset224
IF %ch%==225 GOTO changeset225
IF %ch%==226 GOTO changeset226
IF %ch%==227 GOTO changeset227
IF %ch%==228 GOTO changeset228
IF %ch%==229 GOTO changeset229
IF %ch%==230 GOTO changeset230
IF %ch%==231 GOTO changeset231
IF %ch%==232 GOTO changeset232
IF %ch%==233 GOTO changeset233
IF %ch%==234 GOTO changeset234
IF %ch%==235 GOTO changeset235
IF %ch%==236 GOTO changeset236
...
CLS
ECHO.
ECHO import: Changeset 224
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\224_world_gameobject_loot_template.sql
ECHO Changeset 224 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 225
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\225_world_gameobject_involvedrelation.sql
ECHO Changeset 225 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 226
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\226_world_playercreateinfo.sql
ECHO Changeset 226 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 227
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\227_world_gameobject_template.sql
ECHO Changeset 227 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 228
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\228_world_creature.sql
ECHO Changeset 228 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 229
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\229_world_creature_template.sql
ECHO Changeset 229 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 230
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\230_world_creature_template_addon.sql
ECHO Changeset 230 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 231
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\231_world_creature_template.sql
ECHO Changeset 231 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 232
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\232_world_gameobject_involvedrelation.sql
ECHO Changeset 232 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 233
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\233_world_npc_vendor.sql
ECHO Changeset 233 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 234
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\234_world_npc_vendor.sql
ECHO Changeset 234 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 235
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\235_world_gameobject_loot_template.sql
ECHO Changeset 235 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 236
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\236_world_creature_template.sql
ECHO Changeset 236 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 237
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\237_world_Ari_Kezan_Gameobject_Spawns.sql
ECHO Changeset 237 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 238
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\238_world_Ari_Kezan_NPC_Spawns.sql
ECHO Changeset 238 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
