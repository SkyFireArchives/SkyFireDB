...
ECHO          บ      SkyFireDB 406a Rev 279    บ
...
ECHO   changeset 266 = 266
ECHO   changeset 267 = 267
ECHO   changeset 268 = 268
ECHO   changeset 269 = 269
ECHO   changeset 270 = 270
ECHO   changeset 271 = 271
ECHO   changeset 272 = 272
ECHO   changeset 273 = 273
ECHO   changeset 274 = 274
ECHO   changeset 275 = 275
ECHO   changeset 276 = 276
ECHO   changeset 277 = 277
ECHO   changeset 278 = 278
ECHO   changeset 279 = 279
ECHO.
...
IF %ch%==266 GOTO changeset266
IF %ch%==267 GOTO changeset267
IF %ch%==268 GOTO changeset268
IF %ch%==269 GOTO changeset269
IF %ch%==270 GOTO changeset270
IF %ch%==271 GOTO changeset271
IF %ch%==272 GOTO changeset272
IF %ch%==273 GOTO changeset273
IF %ch%==274 GOTO changeset274
IF %ch%==275 GOTO changeset275
IF %ch%==276 GOTO changeset276
IF %ch%==277 GOTO changeset277
IF %ch%==278 GOTO changeset278
IF %ch%==279 GOTO changeset279
IF %ch%==b GOTO begin
IF %ch%==B GOTO begin
...
CLS
ECHO
ECHO import: Changeset 261
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\261_creature_addon.sql
ECHO Changeset 261 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 262
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\262_creature_addon.sql
ECHO Changeset 262 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 266
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\266_creature_template.sql
ECHO Changeset 266 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 267
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\267_skinning_loot_template.sql
ECHO Changeset 267 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 268
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\268_npc_vendor.sql
ECHO Changeset 268 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 269
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\269_creature_addon.sql
ECHO Changeset 269 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 270
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\270_quest_template.sql
ECHO Changeset 270 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 271
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\271_creature_template.sql
ECHO Changeset 271 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 272
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\272_npc_vendor.sql
ECHO Changeset 272 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 273
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\273_item_template.sql
ECHO Changeset 273 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 274
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\274_creature_template.sql
ECHO Changeset 274 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 275
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\275_gameobject_loot_template.sql
ECHO Changeset 275 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 276
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\276_creature_template.sql
ECHO Changeset 276 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 277
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\277_gameobject_template.sql
ECHO Changeset 277 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 278
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\278_npc_trainer.sql
ECHO Changeset 278 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO
ECHO import: Changeset 279
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\279_npc_trainer.sql
ECHO Changeset 279 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
