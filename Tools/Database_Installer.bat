...
ECHO   changeset 186 = 186
ECHO   changeset 187 = 187
ECHO   changeset 188 = 188
ECHO   changeset 189 = 189
ECHO.
...
IF %ch%==186 GOTO changeset186
IF %ch%==187 GOTO changeset187
IF %ch%==188 GOTO changeset188
IF %ch%==189 GOTO changeset189
IF %ch%==b GOTO begin
IF %ch%==B GOTO begin
...
CLS
ECHO.
ECHO import: Changeset 183
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\183_world_creature.sql
ECHO Changeset 183 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 186
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\186_world_creature.sql
ECHO Changeset 186 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 187
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\187_world_creature_template.sql
ECHO Changeset 187 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 188
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\188_world_quest_27424.sql
ECHO Changeset 188 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 189
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\189_world_quest_12299.sql
ECHO Changeset 189 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
