...
ECHO          บ      SkyFireDB 406a Rev 157    บ
...
ECHO.   
ECHO   changeset 157 = 157  No File Yet
ECHO.
...
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\157_157_world_gameobject_loot_template.sql
