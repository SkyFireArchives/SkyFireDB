...
ECHO          บ      SkyFireDB 406a Rev 156    บ
...
IF %ch%==148 GOTO changeset148
IF %ch%==149 GOTO changeset149
...
IF %ch%==155 GOTO changeset155
IF %ch%==156 GOTO changeset156
IF %ch%==b GOTO begin
IF %ch%==B GOTO begin
...
CLS
ECHO.
ECHO import: Changeset 149
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\149_world_creature.sql
ECHO Changeset 149 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 150
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\150_world_creature_template.sql
ECHO Changeset 150 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 151
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\151_world_creature.sql
ECHO Changeset 151 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 155
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\155_world_player_classlevelstats.sql
ECHO Changeset 155 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
...
CLS
ECHO.
ECHO import: Changeset 156
%mysqlpath%\mysql --host=%host% --user=%user% --password=%pass% --port=%port% %world_db% < %changsql%\156_world_player_levelstats.sql
ECHO Changeset 156 imported sucesfully!
ECHO.
PAUSE   
GOTO changeset
