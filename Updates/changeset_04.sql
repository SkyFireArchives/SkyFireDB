...
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Alchemy Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Blacksmithing Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Enchanting Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Engineering Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Herbalism Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Inscription Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Jewelcrafting Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Leatherworking Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Mining Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Skinning Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Tailoring Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Archaeology Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Cooking Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%First Aid Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Fishing Trainer%';
UPDATE creature_template SET npcflag=80 WHERE subname LIKE '%Riding Trainer%';

-- Proffesion Trainer NPC FLAG FIX (82)
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Alchemy Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Blacksmithing Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Enchanting Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Engineering Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Herbalism Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Inscription Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Jewelcrafting Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Leatherworking Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Mining Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Skinning Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Tailoring Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Archaeology Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Cooking Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%First Aid Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Fishing Trainer%' AND entry in (SELECT id FROM creature_questrelation);
UPDATE creature_template SET npcflag=82 WHERE subname LIKE '%Riding Trainer%' AND entry in (SELECT id FROM creature_questrelation);
