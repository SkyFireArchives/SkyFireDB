...
CREATE TABLE `creature` (
  ...
  `map` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT 'Map Identifier',
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1000000000 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
